...
| 2025 | 🟪 🔴 Dome-DETR | arXiv 2025.05 (2505.05741) | AI-TOD-V2 test / VisDrone val(800²) | **34.6 AP(+3.3)/39.0 AP(+2.5)双SOTA**(L,36M);碾压DQ-DETR(1782G→376G) | D-FINE底座;DeFE密度头(0.8M,GT高斯监督+DRFL)→MWAS浅层掩码窗口稀疏(APE轴置换注意力)+PAQI自适应query(Dynamic NMS);⚠️GFLOPs+37%非净省/保留NMS/判据需监督 → #30 对照叙事;❌判死#5-D | 未开源(声明accept后放) |
